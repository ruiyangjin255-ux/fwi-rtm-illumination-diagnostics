...
def test_check_manuscript_reports_core_jge_limits(tmp_path: Path) -> None:
    manuscript = Path("admit_fwi/docs/jge_submission_package_mainfigures/manuscript/sci_fwi_rtm_innovation_manuscript_draft.md")
    if not manuscript.exists():
        manuscript = Path("docs/sci_fwi_rtm_innovation_manuscript_draft.md")
    if not manuscript.exists():
        manuscript = Path("admit_fwi/docs/sci_fwi_rtm_innovation_manuscript_draft.md")
