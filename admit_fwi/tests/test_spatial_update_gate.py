...
from admit_fwi.build_spatial_update_gate import build, load_gate_inputs, scan_spatial_update_gates


RAW_INPUT = Path("admit_fwi/outputs/FWI/full_salt_fwi_cg_allshots_v2/full_salt_true_model.npy")
