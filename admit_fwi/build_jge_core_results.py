...
from admit_fwi.evaluate_fwi_model_quality import evaluate_run_dir
...
def build_innovation_rows() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "evidence": "Existing learning-based FWI extension smoke and small-sample OpenFWI results",
