...
def main() -> None:
    ...
    parser.add_argument("--result-dir", type=Path, default=ROOT / "admit_fwi" / "outputs" / "salt_reliability_gate_v1")
    parser.add_argument("--fwi-dir", type=Path, default=ROOT / "admit_fwi" / "outputs" / "FWI" / "full_salt_fwi_cg_allshots_ecg_v1")
