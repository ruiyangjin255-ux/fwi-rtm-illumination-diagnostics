...
from admit_fwi.plot_paper_style import save_migration_figure, save_record_and_migration_figure
...
def main() -> None:
    ...
    parser.add_argument("--model-dir", type=Path, default=ROOT / "admit_fwi" / "outputs" / "salt_reliability_gate_audit0_v1" / "models")
    parser.add_argument("--output-dir", type=Path, default=ROOT / "admit_fwi" / "outputs" / "RTM" / "audit0_gate_rtm_v1")
    ...
    output_dir = ROOT / "admit_fwi" / "outputs" / "RTM" / "smoke_gate_rtm_audit0" if args.smoke else args.output_dir
