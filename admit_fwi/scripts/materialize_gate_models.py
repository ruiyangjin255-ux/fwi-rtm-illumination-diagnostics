...
def main() -> None:
    ...
    result_dir = ROOT / config.get("output_dir", "admit_fwi/outputs/salt_reliability_gate_audit0_v1")
    if args.smoke:
        result_dir = ROOT / "admit_fwi" / "outputs" / "smoke_reliability_gate_audit0"
    fwi_dir = args.fwi_dir
    if fwi_dir is None:
        fwi_dir = ROOT / "admit_fwi" / "outputs" / "FWI" / "full_salt_fwi_cg_audit0_train_ecg_v1"
