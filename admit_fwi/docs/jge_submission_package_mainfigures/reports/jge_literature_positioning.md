...
| 2023 | An efficient plug-and-play regularization method for full waveform inversion | https://doi.org/10.1093/jge/gxad073 | Supports a future route using learned or denoising priors, but our `learning-based FWI extension` branch is not yet strong enough for the main claim. |
...
```powershell
python -m admit_fwi.build_jge_core_results
```
