...
**文件：**
- 修改：`D:\ryjin\rtm_acoustic\tests\test_acoustic_rtm.py`
...
**文件：**
- 修改：`D:\ryjin\rtm_acoustic\acoustic_rtm.py`
...
**文件：**
- 新增：`D:\ryjin\rtm_acoustic\run_scheme2_imaging_condition_compare.py`
...
命令：`python -m rtm_acoustic.run_scheme2_imaging_condition_compare --output-dir rtm_acoustic\outputs\seg_salt_scheme2_smoke --max-shots 6 --nt 500 --workers 1`
...
- `python -m pytest rtm_acoustic\tests\test_optimize_existing_salt_result.py -q`
