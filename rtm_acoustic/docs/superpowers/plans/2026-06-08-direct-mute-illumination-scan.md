...
**Tech Stack:** Python、NumPy、Matplotlib、CSV、pytest、现有 `rtm_acoustic.acoustic_rtm`。
...
**Files:**
- Read: `D:\ryjin\rtm_acoustic\outputs\small_salt_full_waveform_mute_scan\mute_scan_summary.json`
