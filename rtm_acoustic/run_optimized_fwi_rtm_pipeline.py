...
from rtm_acoustic.evaluate_fwi_model_quality import evaluate_run_dir, write_outputs
from rtm_acoustic.optimize_fwi_update_scale import DEFAULT_ALPHAS, optimize_run_dir
...
DEFAULT_TRUE_MODEL = ROOT / "波场数值模拟" / "声波场" / "fd2d_pml" / "vel" / "seg676x230.bin"
DEFAULT_RTM_DIR = ROOT / "rtm_acoustic" / "outputs" / "RTM" / "before_after_fwi_alpha010_nt1200_shots12"
