...
from rtm_acoustic.diagnostics.time_sampling_audit import array_stats, record_time, strict_disjoint, wavelet_summary
...
def main() -> None:
    ...
    out_dir = ROOT / config.get("output_dir", "rtm_acoustic/outputs/deep_time_preflight_v1")
    out_dir.mkdir(parents=True, exist_ok=True)
    fwi_dir = ROOT / config.get("fwi_dir", "rtm_acoustic/outputs/FWI/full_salt_fwi_cg_audit0_train_ecg_v1")
    short_rtm_dir = ROOT / config.get("short_rtm_dir", "rtm_acoustic/outputs/RTM/audit0_gate_rtm_v1")
    gate_dir = ROOT / config.get("gate_dir", "rtm_acoustic/outputs/salt_reliability_gate_audit0_v1")
