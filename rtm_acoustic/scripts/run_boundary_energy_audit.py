...
from rtm_acoustic.diagnostics.boundary_energy_audit import boundary_energy_ratio, classify_boundary_energy
...
def main() -> None:
    ...
    preflight = ROOT / config.get("output_dir", "rtm_acoustic/outputs/deep_time_preflight_v1")
