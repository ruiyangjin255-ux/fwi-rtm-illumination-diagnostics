...
def main() -> None:
    ...
    base_output_dir = ROOT / config.get("output_dir", "rtm_acoustic/outputs/salt_reliability_gate_audit0_v1")
    output_dir = ROOT / "rtm_acoustic" / "outputs" / "smoke_reliability_gate_audit0" if args.smoke else base_output_dir
