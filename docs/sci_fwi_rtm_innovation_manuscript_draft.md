...
近年深度学习 FWI 和 OpenFWI 数据集推动了端到端速度反演研究，但本项目现有 `fwi_visionfm` 结果仍处于小样本验证阶段，不能替代本文物理 FWI/RTM 的主证据。
...
| 图 4 | 照明可信域空间 FWI 更新门控与候选质量前沿 | `D:\ryjin\rtm_acoustic\docs\jge_main_figures\figure4_spatial_update_gate.tiff` |
...
| 表 3 | 空间更新门控候选扫描与选中策略 | `D:\ryjin\rtm_acoustic\docs\jge_revision\spatial_update_gate_candidates.csv` |
